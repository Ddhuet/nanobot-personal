...
class AgentLoop:
    ...
    def __init__(
        ...
        consolidation_keep_messages: int = 20,
        ...
        self.memory_consolidator = MemoryConsolidator(
            ...
            keep_messages=consolidation_keep_messages,
